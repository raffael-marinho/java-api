...
public class TestePacienteDAO {
	public static void main(String[] args) {
		...
		/*
		 * pacienteDAO.cadastrar(paciente1); System.out.println("Paciente cadastrado: "
		 * + paciente1.getNome());
		 * 
		 * // Teste de listagem System.out.println("Listando pacientes:"); for (Paciente
		 * p : pacienteDAO.listar()) { System.out.println(p); }
		 */
		...
		/*
		 * // Teste de deleção pacienteDAO.deletar(paciente1.getId());
